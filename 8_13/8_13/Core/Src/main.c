...
GPIO_TypeDef* led_ports[] = { LED_GPIO_Port,LEDA5_GPIO_Port }; 
uint16_t led_pins[] = {GPIO_PIN_4,GPIO_PIN_5 }; 
/* USER CODE END PV */
...
{   
    ...
    __HAL_TIM_SetCompare(&htim3, TIM_CHANNEL_2, 1000-i);
...
{   
    ...
    __HAL_TIM_SetCompare(&htim3, TIM_CHANNEL_2, 1000-j);
    HAL_Delay(200);
}
    /* USER CODE END WHILE */
